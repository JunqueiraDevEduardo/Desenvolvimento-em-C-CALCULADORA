...
# 418 "/usr/include/bits/mathcalls.h" 3 4
...
# 468 "/usr/include/bits/mathcalls.h" 3 4
...
if (argc == 3) {
    ...
    const char *op = 
# 82 "calculadora.c" 3 4
                    ((void *)0)
# 82 "calculadora.c"
                        ;
    const char *numstr = 
# 83 "calculadora.c" 3 4
                        ((void *)0)
# 83 "calculadora.c"
                            ;
    ...
    if (strcmp(op, "sqrt") == 0) {
        if (a < 0) { fprintf(
# 94 "calculadora.c" 3 4
                            stderr
# 94 "calculadora.c"
                                  , "sqrt invalida para negativo.\n"); return 3; }
        double r = sqrt(a);
        printf("sqrt(%.6f) = %.10f\n", a, r);
        return 0;
        ...
        fprintf(
# 111 "calculadora.c" 3 4
               stderr
# 111 "calculadora.c"
                     , "Funcao unitaria \"%s\" desconhecida.\n", op);
        return 4;
    }
}
